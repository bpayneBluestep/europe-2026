...
const TRIP = {
  ...
  transit: [
    ...
    { id: "comosg", kind: "rail", name: "Como San Giovanni",
      ...
      when: "Day 9 \u00b7 arrive 2:23 PM. Get off here, NOT Chiasso. Taxi rank out front on Piazzale San Gottardo \u2014 ~40 min up to Griante, agree the price first." },
    ...
    { id: "milano", kind: "rail", name: "Milano Centrale",
      ...
      when: "Day 9 \u00b7 28-minute transfer, 1:15 \u2192 1:43 PM. All platforms on one raised level \u2014 walk the concourse at the head of the tracks, never leave the platform zone. Regionals use the outer platforms (1\u20134 / 21\u201324)." },
  ...
  stays: [
    ...
    },
    {
      ...
      notes: "The room is settled at the desk, not prepaid — the card only guarantees it, and there is a city tax on departure. Room and Wi-Fi only, no breakfast. Free cancellation until 13:00 on 19 Sep. Departure: private water taxi booked for 9:30 AM Fri 25 Sep — confirm with reception where it meets you (hotel water door or nearest landing).",
    },
    {
      img: "como-lake",
  ...
  tickets: [
    ...
    },
    {
      ...
      links: [
        ...
        { label: "What the regional looks like (photo)", url: "https://commons.wikimedia.org/wiki/File:Hitachi_Caravaggio_Top-deck_Interior.jpg" },
      ],
      ...
      notes: "Guest purchase. Resend code 1842017435. TWO BARCODES PER PERSON: the first pair below is the Frecciarossa (scan at the Venice gate), the second pair is the Trenord regional (show the conductor after Milan) — different operator, different ticket, not interchangeable. Frecciarossa luggage: tall racks at each end of coach 5, overhead for backpacks, board early because Venice is the origin. Regional: no assigned seats; stand the big cases in the door vestibule / low-floor racks and sit on the lower level next to them. The four barcodes came off the self check-in link on 29 Aug.",
      account: "paynefamily522@gmail.com",
